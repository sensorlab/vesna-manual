...
command-line interfaces and scripting. An short overview of both is given below
...
The following instructions presume you are working in a terminal emulator,
...
\begin{verbatim}
# aptitude install flex bison libgmp3-dev libmpfr-dev \
...
listed in the error message using \verb|aptitude install|.
...
To test the setup we will compile, program and debug a short program that blinks
