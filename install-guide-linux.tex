...
%    \begin{figure}[H]
%    \centering
%        \includegraphics[width=0.9\textwidth]{./install-guide-linux-images/synaptic-gtkterm.png}
...
%    \begin{figure}[H]
%    \centering
%        \includegraphics[width=0.8\textwidth]{./install-guide-linux-images/eclipse-subversive.png}
...
%    \begin{figure}[H]
%    \centering
%        \includegraphics[width=0.8\textwidth]{./install-guide-linux-images/eclipse-subversive-setup.png}
...
%    \begin{figure}[H]
%    \centering
%        \includegraphics[width=0.8\textwidth]{./install-guide-linux-images/test-prj-svn.png}
...
%    \begin{figure}[H]
%    \centering
%        \includegraphics[width=0.9\textwidth]{./install-guide-linux-images/test-import-svn.png}
...
%    \begin{figure}[H]
%    \centering
%        \includegraphics[width=0.8\textwidth]{./install-guide-linux-images/gtkterm-config.png}
...
%    \begin{figure}[H]
%    \centering
%        \includegraphics[width=\textwidth]{./install-guide-linux-images/hello-world.png}
%        \caption{Hello world messages on serial terminal}
%        \label{fig:hello-world}
%    \end{figure}
...
\bibitem{mm10}
	% TODO FIXME update reference manual to "VESNA" manual
